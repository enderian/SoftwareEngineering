...
<!--* Το σύστημα θα πρέπει να υποστηρίζει έως και 100 ταυτόχρονους χρήστες.-->

#### Διαθεσιμότητα

<!--* Το σύστημα θα είναι διαθέσιμο 24 ώρες για 7 μέρες της εβδομάδας.-->
...
* Ο χρήστης θα πρέπει να είναι σε θέση να χρησιμοποιήσει την εφαρμογή μετά από 30 λεπτά χρησιμοποιώντας την.
