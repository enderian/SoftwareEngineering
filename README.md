...
# Εισαγωγή
Στο παρών έγγραφο θα αναλυθούν όλες οι λεπτομέρεις που αφορούν την εφαρμογή διαφείρισης εργαστηρίων CSLabs. Συγκεκριμένα θα γίνει λεπτομερής ανάλυση των περιπτώσεων χρήσης καθώς και του μοντέλου πεδίου του συστήματός μας.
...
Στη συνέχεια, θα αναλύσουμε πλήρως το λογισμικό, τους διάφορους χρήστες, τις διεπαφές, τις κλάσεις του, την οργάνωσή του και άλλα.
...
#### [ΠΧ2: Προβολή κατάστασης υπολογιστών](Deliverables/R2/uc2-lab-pc-status.md)
...
#### [ΠΧ4: Απομακρυσμένος έλεγχος μηχανημάτων](Deliverables/R2/uc5-remote-control.md)

#### [ΠΧ5: Προβολή ιστορικού χρήσης](Deliverables/R2/uc6-history.md)

#### [ΠΧ6: Καταχώρηση νέων μηχανημάτων](Deliverables/R2/uc7-machine-registration.md)

#### [ΠΧ7: Δημιουργία και χρήση προτύπων νέων μηχανημάτων](Deliverables/R2/uc8-configuration-generation.md)
